...
public class NotifiableDictionary<TKey, TValue>
    :
    ...
    where TKey : notnull
{
    private class CommonPropertyNames
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NotifiableDictionary{TKey, TValue}"/> class using an IDictionary.
    /// </summary>
    public NotifiableDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer = null)
    {
        if (dictionary != null)
        {
